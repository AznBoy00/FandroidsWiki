...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_notes_registration);
    ...
    private void registrationFunction(){
        ...
        signHere=findViewById(R.id.signinhere);
                ...
                mAuth.createUserWithEmailAndPassword(email,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            mDialog.dismiss();
                            Toast.makeText(getApplicationContext(),"Registration Filed", Toast.LENGTH_SHORT).show();
